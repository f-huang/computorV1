...
/*   Updated: 2017/12/19 16:42:55 by fhuang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	equation::is_overflowing()
{
	...
	return (
		b > 46430 || b < -46430 ||
		(a > 536870911 && c != 0) || (a < -536870911 && c != 0) ||
		a > 2147483647 / (4 * c) || a < -2147483647 / (4 * c) ||
		(c > 536870911 && a != 0) || (c < -536870911 && a != 0) ||
		c > 2147483647 / (4 * a) || c < -2147483647 / (4 * a)
	);
}
